...
import { SettingsIcon, LogOut, Zap, Grid2X2, BookOpen, History, TrendingUp, BarChart2, Activity, Globe, Store } from "lucide-react";
...
const routes = [
  ...
  { label: "Spot Market",      href: "/spot-market",  icon: Store,       group: "SPOT"    },
